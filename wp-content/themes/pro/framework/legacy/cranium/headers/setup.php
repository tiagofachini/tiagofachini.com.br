...
require_once( X_TEMPLATE_PATH . '/framework/legacy/cranium/headers/functions/navbar.php' );
require_once( X_TEMPLATE_PATH . '/framework/legacy/cranium/headers/functions/classes.php' );
...
add_action( 'x_legacy_css', 'x_legacy_cranium_headers_generated_css' );
