...
if ( ! function_exists( 'x_ethos_entry_top_navigation' ) ) :
  function x_ethos_entry_top_navigation() {
    ...
    ?>
      ...
      <a href="<?php echo $link; ?>" class="entry-parent" title="<?php echo $title; ?>"> <?php x_icon_output( "f00a", "x-icon-th"); ?></a>
        ...
        <div class="x-comment-content-wrap">
          <header class="x-comment-header">
            ...
            <div class="x-comment-meta">
              ...
              <?php endif; ?>
              <?php edit_comment_link( __( 'Edit ' . x_icon_get("f044", "x-icon-edit"), '__x__' ) ); ?>
            </div>
            <?php
...
// Comment Fields
// @TODO this runs for all stacks move this or disable for only with ethos
// =============================================================================
