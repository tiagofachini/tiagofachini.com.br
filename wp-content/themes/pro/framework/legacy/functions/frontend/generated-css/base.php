...
<?php
// Stepped font breakpoint output
if (function_exists("cs_breakpoint_output_loop_output")) {
  cs_breakpoint_output_loop_output([
    "font-size: " . $x_root_font_size_stepped_sm . $x_root_font_size_stepped_unit . ';',
    "font-size: " . $x_root_font_size_stepped_md . $x_root_font_size_stepped_unit . ';',
    "font-size: " . $x_root_font_size_stepped_lg . $x_root_font_size_stepped_unit . ';',
    "font-size: " . $x_root_font_size_stepped_xl . $x_root_font_size_stepped_unit . ';',
  ], "html {", "}");
}
?>
...
body {
  ...
  <?php if ( $x_design_bg_image_pattern == '' ) : ?>
    background: <?php echo $x_design_bg_color; ?>;
  <?php else : ?>
