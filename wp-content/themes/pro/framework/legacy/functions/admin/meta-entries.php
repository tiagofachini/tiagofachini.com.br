...
function x_add_design_meta_boxes() {
  ...
  if ( class_exists( 'RevSlider' ) || class_exists( 'RevSliderSlider' ) || class_exists( 'LS_Sliders' ) ) :
...
add_action( 'add_meta_boxes', 'x_add_design_meta_boxes' );
