...
function x_legacy_layerslider_get_slider_meta() {

  $sliders = LS_Sliders::find( array( 'order' => 'ASC', 'limit' => apply_filters( 'cs_query_limit', 2500 ) ) );
  $data    = array();
...
function x_layerslider_add_slider_meta( $meta ) {
  ...
  return array_merge( $meta, x_legacy_layerslider_get_slider_meta() );
