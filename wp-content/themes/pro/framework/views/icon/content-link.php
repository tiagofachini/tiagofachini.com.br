    ...
    <div class="x-container max width">
      <header class="entry-header">
        ...
        <h1 class="entry-title">
          <a href="<?php echo esc_url( $link ); ?>" title="<?php echo esc_attr( sprintf( __( 'Shared link from post: "%s"', '__x__' ), the_title_attribute( 'echo=0' ) ) ); ?>" <?php x_output_target_blank(); ?> class="entry-external-link"><?php x_icon_output("f0c6", "x-icon-paperclip"); ?></a>
          <?php echo $link; ?>
        </h1>
        <?php else : ?>
