...
class CS_Revolution_Slider extends Cornerstone_Element_Base {
  ...
  public function controls() {
    ...
    if ( class_exists('RevSliderSlider') ) {
      $new_rev_slider = new RevSliderSlider();
      $rev_sliders    = $new_rev_slider->get_sliders();
  ...
  public function is_active() {
    return defined('RS_REVISION') || class_exists('RevSlider') || class_exists('RevSliderSlider');
  }
