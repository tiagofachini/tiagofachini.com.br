...
<form <?php echo cs_atts( $atts_form ); ?>>
  <h4 class="x-login-title">Login</h4>
  <div>
    <label><?php esc_html__( 'Username', 'cornerstone' ); ?></label>
    <input <?php echo cs_atts( $atts_input_user ); ?>>
  </div>
  <div>
    <label><?php esc_html__( 'Password', 'cornerstone' ); ?></label>
    <input <?php echo cs_atts( $atts_input_pass ); ?>>
  </div>
  <div>
    <input <?php echo cs_atts( $atts_input_submit ); ?>>
  </div>
  <input <?php echo cs_atts( $atts_input_hidden ); ?>>
</form>
