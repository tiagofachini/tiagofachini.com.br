...
<div class="rmp-tab-content rmp-tab-content--visible js-rmp-tab-content js-rmp-tab-content--1">
    ...
    <table class="rmp-tab-content__table">
        <tr>
            <td>
                ...
                </label> <select class="rmp-tab-content__select js-rmp-option" data-key="icon_type">
            ...
            <td>
                ...
                </label> <select class="rmp-tab-content__select js-rmp-option" data-key="widgetAlign">
    ...
    </label> <select class="rmp-tab-content__select js-rmp-option" data-key="structuredDataType">
        <option
            value="none" <?php echo ($rmp_options['structuredDataType'] === 'none') ? 'selected="selected"' : ""; ?>> <?php echo(esc_html__('Without structured data', 'rate-my-post')); ?></option>
        <option
            value="Product" <?php echo ($rmp_options['structuredDataType'] === 'Product') ? 'selected="selected"' : ""; ?>>
            Product
        </option>
        <option
            value="Book" <?php echo ($rmp_options['structuredDataType'] === 'Book') ? 'selected="selected"' : ""; ?>>
            Book
        </option>
        <option
            value="Course" <?php echo ($rmp_options['structuredDataType'] === 'Course') ? 'selected="selected"' : ""; ?>>
            Course
        </option>
        <option
            value="CreativeWorkSeason" <?php echo ($rmp_options['structuredDataType'] === 'CreativeWorkSeason') ? 'selected="selected"' : ""; ?>>
            CreativeWorkSeason
        </option>
        <option
            value="CreativeWorkSeries" <?php echo ($rmp_options['structuredDataType'] === 'CreativeWorkSeries') ? 'selected="selected"' : ""; ?>>
            CreativeWorkSeries
        </option>
        <option
            value="Episode" <?php echo ($rmp_options['structuredDataType'] === 'Episode') ? 'selected="selected"' : ""; ?>>
            Episode
        </option>
        <option
            value="Game" <?php echo ($rmp_options['structuredDataType'] === 'Game') ? 'selected="selected"' : ""; ?>>
            Game
        </option>
        <option
            value="LocalBusiness" <?php echo ($rmp_options['structuredDataType'] === 'LocalBusiness') ? 'selected="selected"' : ""; ?>>
            LocalBusiness
        </option>
        <option
            value="MediaObject" <?php echo ($rmp_options['structuredDataType'] === 'MediaObject') ? 'selected="selected"' : ""; ?>>
            MediaObject
        </option>
        <option
            value="Movie" <?php echo ($rmp_options['structuredDataType'] === 'Movie') ? 'selected="selected"' : ""; ?>>
            Movie
        </option>
        <option
            value="MusicPlaylist" <?php echo ($rmp_options['structuredDataType'] === 'MusicPlaylist') ? 'selected="selected"' : ""; ?>>
            MusicPlaylist
        </option>
        <option
            value="MusicRecording" <?php echo ($rmp_options['structuredDataType'] === 'MusicRecording') ? 'selected="selected"' : ""; ?>>
            MusicRecording
        </option>
        <option
            value="Organization" <?php echo ($rmp_options['structuredDataType'] === 'Organization') ? 'selected="selected"' : ""; ?>>
            Organization
        </option>
        <option
            value="Recipe" <?php echo ($rmp_options['structuredDataType'] === 'Recipe') ? 'selected="selected"' : ""; ?>>
            Recipe
        </option>
    </select>
    <p class="rmp-tab-content__notice">
    ...
    <table
        class="rmp-tab-content__table rmp-tab-content__table--padding rmp-tab-content__table--hidden js-rmp-social-follow-links">
        <tr>
            <td>
                <label class="rmp-tab-content__label rmp-tab-content__label--block" for="rmp-facebook">
                    <?php echo(esc_html__('Your Facebook Page URL', 'rate-my-post')); ?>: </label> <input
                    type="text"
            ...
            <td>
                <label class="rmp-tab-content__label rmp-tab-content__label--block"
                       for="rmp-pinterest"><?php echo(esc_html__('Your Pinterest Page URL', 'rate-my-post')); ?>
                    :</label> <input
                    type="text"
                    class="rmp-tab-content__input rmp-tab-content__input--long js-rmp-option"
                    id="rmp-pinterest"
        ...
        <tr>
            <td>
                <label class="rmp-tab-content__label rmp-tab-content__label--block"
                       for="rmp-youtube"><?php echo(esc_html__('Your Youtube Page URL', 'rate-my-post')); ?>:</label>
                <input
                    type="text"
                    class="rmp-tab-content__input rmp-tab-content__input--long js-rmp-option"
                    id="rmp-youtube"
            ...
            <td>
                <label class="rmp-tab-content__label rmp-tab-content__label--block"
                       for="rmp-flickr"><?php echo(esc_html__('Your Flickr Page URL', 'rate-my-post')); ?>:</label>
                <input
                    type="text"
                    class="rmp-tab-content__input rmp-tab-content__input--long js-rmp-option"
                    id="rmp-flickr"
        ...
        <tr>
            <td>
                <label class="rmp-tab-content__label rmp-tab-content__label--block"
                       for="rmp-instagram"><?php echo(esc_html__('Your Instagram Page URL', 'rate-my-post')); ?>
                    :</label> <input
                    type="text"
                    class="rmp-tab-content__input rmp-tab-content__input--long js-rmp-option"
                    id="rmp-instagram"
            ...
            <td>
                <label class="rmp-tab-content__label rmp-tab-content__label--block"
                       for="rmp-twitter"><?php echo(esc_html__('Your Twitter Page URL', 'rate-my-post')); ?>:</label>
                <input
                    type="text"
                    class="rmp-tab-content__input rmp-tab-content__input--long js-rmp-option"
                    id="rmp-twitter"
        ...
        <tr>
            <td>
                <label class="rmp-tab-content__label rmp-tab-content__label--block"
                       for="rmp-linkedin"><?php echo(esc_html__('Your Linkedin Page URL', 'rate-my-post')); ?>:</label>
                <input
                    type="text"
                    class="rmp-tab-content__input rmp-tab-content__input--long js-rmp-option"
                    id="rmp-linkedin"
